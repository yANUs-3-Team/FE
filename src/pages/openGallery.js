...
function OpenGallery() {
  ...
  const allCovers = Array.from({ length: 91 }, (_, idx) => ({
    id: idx + 1,
  }));
    ...
    <>
      <div className="openGallery_page">
        <div className="galleryTitle_box2">
          ...
          <div className="OG_speechBubble">
            다른 사람들이 만든 작품을 함께 볼까요?
          </div>
        ...
        <div className="OGpagination_container">
          <div className="OGpagination_wrapper">
            {currentGroup > 0 && (
              <button
                className="OGpagination_arrow left"
            ...
            <div className="OGpagination_center">
            ...
            {groupEnd < totalPages && (
              <button
                className="OGpagination_arrow right"
