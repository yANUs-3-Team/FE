            ...
            <div className="sketch">
                ...
                <div className="sketch_menuBox">
                    {menuList.map((text, i) => (
                        <div
                        key={`menu-${i}`}
                        className={`sketch_menu ${i === pageIndex && pageIndex !== 6 ? "selected" : ""}`}
                        >
                        {text}
                        </div>
                    ))}
                ...
                {(() => {
                  switch (pageIndex) {
                    ...
                    case 2:
                        return (
                            <div className="select_box">
                                <div className="select_container" style={{ flexDirection: "column", gap: "1vh" }}>
                                    <textarea
                            ...
                            <div className="select_box2">
                                ...
                                <div className="select_container2">
                                    <div className="selected_group">
                                        ...
                                        <div className="selected_value2">{characteristics || "선택되지 않음"}</div>
                                    </div>
                                </div>
                                <div className="select_container2">
                                    <div className="selected_group">
                                ...
                                <div className="select_container">
                                    <div className="selected_group">
                                        <div className="selected_label">나만 보기</div>
                                        
                                    </div>
                                    <div className="selected_group">
                                        <div className="selected_label">전체 공개</div>
                                    </div>
                                </div>
                            </div>
                        )
                    default:
                        return <div className="select_box">잘못된 페이지입니다.</div>;
                  }
                })()}
              </div>
